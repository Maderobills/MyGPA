 ...
 * Use the {@link HelpSupport#newInstance} factory method to
...
public class HelpSupport extends Fragment {
    ...
    public static HelpSupport newInstance(String param1, String param2) {
        HelpSupport fragment = new HelpSupport();
